...
public class EUExAudio2 extends EUExBase {
    ...
    public EUExAudio2(Context context, EBrowserView inParent) {
        ...
        if (F_ACT_REQ_CODE_UEX_AUDIO_RECORD == requestCode) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                if(mRecordCallbackId!=-1){
                    ...
                    jsCallback(EUExAudio2.F_CALLBACK_NAME_AUDIO_RECORD, 0, EUExCallback.F_C_TEXT, returnPath);
                }
              }
        }
    }
